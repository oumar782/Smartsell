  ...
  const footerLinks = [
    {
      title: 'Services',
      links: [
        { name: 'Design Graphique', url: '#' },
        { name: 'Développement Web', url: '#' },
        { name: 'Marketing Digital', url: '#' },
        { name: 'Stratégie de Marque', url: '#' },
      ]
    },
    {
      title: 'Liens Rapides',
      ...
      <div className="footer-container">
        <div className="footer-grid">
          <div className="footer-company">
            <div className="footer-logo">
              <h3>Smart<span>Sell</span></h3>
            </div>
            <p className="footer-description">
              Agence créative spécialisée dans le design graphique, 
              le développement web et le marketing digital en Guinée.
            </p>
            <div className="footer-contact">
              <div className="footer-contact-item">
                <MapPin size={16} />
                <span>Conakry, Guinée - Quartier Kaloum</span>
              </div>
              <div className="footer-contact-item">
                <Phone size={16} />
                <span>+224 622 45 67 89</span>
              </div>
              <div className="footer-contact-item">
                <Mail size={16} />
                <span>contact@smartsell.com</span>
              </div>
            </div>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p>© {currentYear} SmartSell Agency. Tous droits réservés.</p>
            <p className="footer-made-with">
              Fait avec <Heart size={14} className="heart-icon" /> en Guinée
            </p>
          </div>
        </div>
      </div>
